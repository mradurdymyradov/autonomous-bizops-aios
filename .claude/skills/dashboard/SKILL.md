---
name: dashboard
description: Use when Operator wants the business dashboard — "open the dashboard", "build the dashboard", "show me everything", "refresh the dashboard", "покажи дашборд", "обнови дашборд" — or after STATE.md, TODO.md or a client folder changes and the pipeline on the page needs to catch up. Rebuilds the operations console: today's queue, the 7 pilots, leads, funnel, marketing and system health, as one self-contained HTML file.
---
